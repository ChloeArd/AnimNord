            ...
            foreach ($var['ad'] as $ad) {
                ...
                <div class='post flexColumn flexCenter colorGrey'>
                    ...
                    <div class="userAd flexColumn">
                        ...
                        <a href="../index.php??controller=message&id=<?=$ad->getUserFk()->getId()?>&article=<?=$ad->getId() ?>" class="buttonWhite margin8 colorRed"><i class="far fa-comment-dots"></i>Envoyer un message</a>
