    ...
    <main class="width_80">
        ...
        <form id="formAd" method="post" class="flexColumn width_50" enctype="multipart/form-data">
            ...
            <div class="categoriePet">
                ...
                <div class="flexRow align">
                    <input id="female" type="radio" name="sex" value="Femelle" <?PHP if($ad->getSex() === 'Femelle'){echo "checked";} ?> required>
                    <label for="female" class="margin_0_20">Femelle</label>
                </div>
                <div class="flexRow align">
                    <input id="unknown" type="radio" name="sex" value="Inconnu" <?PHP if($ad->getSex() === 'Inconnu'){echo "checked";} ?> required>
            ...
            <input type="file" name="picture" id="picture" accept="image/png, image/jpeg, image/jpg" size="2000000" value="<?=$ad->getPicture() ?>">
            <span>(Max: 2Mo)</span>

            <input type="hidden" name="picture2" value="<?=$ad->getPicture() ?>">

            <input type="submit" id="updateLost" class="buttonEnter colorWhite radius10 pointer" value="Modifier">
        </form>
    </main>
<?php
}